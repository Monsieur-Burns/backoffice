...
@section('content')
  ...
  <div class="FormulaireCreer col-md-8">
    <form class="form-horizontal" action=' {{ route('acteurs.store') }} ' method='post'>
      ...
      <fieldset>
        <legend>Créer un Réalisateur</legend>
        <div class="form-group">
          <label for="inputPrenom" class="col-lg-2 control-label">Prénom</label>
          <div class="col-lg-10">
            <input name='inputPrenom' class="form-control" id="inputPrenom" placeholder="Prenom du réalisateur" type="text">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input name='inputNom' class="form-control" id="inputNom" placeholder="Nom du réalisateur" type="text">
          </div>
        </div>
...
@section('breadcrumb')
  @parent<li><a href="{{ route('realisateur.creer') }}">Creer un Réalisateurs</a></li>
@endsection
